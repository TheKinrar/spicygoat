...
std::string PacketPlayerPositionLook::toString() const {
    return std::string("PacketPlayerPositionLook{x=") + std::to_string(x) + ",y=" + std::to_string(y) + ",z=" + std::to_string(z) + ",yaw=" + std::to_string(yaw) + ",pitch=" + std::to_string(pitch) + ",onGround=" + std::to_string(onGround) + "}";
}
